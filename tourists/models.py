...
class Tourist(models.Model):
    ...
    visa = models.FileField(blank=True, null=True, upload_to='files',
                                                    verbose_name='Копия визы')
    insurance = models.FileField(blank=True, null=True, upload_to='files', 
                                               verbose_name='Копия страховки')
    passport = models.FileField(blank=True, null=True, upload_to='files', 
                                                verbose_name='Копия паспорта')
    others = models.FileField(blank=True, null=True, upload_to='files', 
...
class Event(models.Model):
    ...
    manager = models.CharField(max_length=200, 
                        verbose_name='Менеджер группы туристов', blank=True)
...
class Excursion(models.Model):
    ...
    note = models.TextField(max_length=500, verbose_name='Описание', 
                                                         blank=True, null=True)
...
class Hotel(models.Model):
    ...
    name = models.CharField(max_length=300, verbose_name='Название отеля', 
